...
Comme $48 \leqslant 45$ (longueur de la valise) est fausse, le bâton ne peut être mis à la verticale.
...
AC$^2 = \text{AB}^2 + \text{BC}^2 = 45^2 + 32^2 = \np{2025} + \np{1024} = \np{3049}$.

La longueur AC est supérieure à zéro, donc AC $= \sqrt{3039} \approx55,2 \approx 55$~(cm) à l'unité près
\item %Justifier que Paul peut placer son bâton dans le fond de la valise.
Maintenant l'inégalité $48 < 55$ est vraie donc le bâton peut rentrer dans la valise.
\end{enumerate}
