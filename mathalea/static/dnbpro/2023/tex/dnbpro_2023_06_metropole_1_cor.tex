...
$\square~\dfrac{1}{8}$ & $\square~\dfrac{8}{22}$ & $\blue\boxtimes~\dfrac{8}{30}$ & $\square~\dfrac{22}{30}$&
&
\psset{unit=0.4cm}
...
$\square~100\times 28 \div 7$ & $\blue\boxtimes~7\times 100 \div 28$ & $\square~100\times 28 \div 7$ & $\square~7\div 100\times 28$
\end{tabular}
\end{center}
...
$\blue\boxtimes~1~\text{cm}^3$ & $\square~2~\text{cm}^3$ & $\square~3~\text{cm}^3$ & $\square~6~\text{cm}^3$
&
...
\begin{center}
\begin{tabular}[t]{*4{m{2.5cm}}}
$\square~0,12$ & $\blue\boxtimes~0,30$ & $\square~3$ & $\square~8$
\end{tabular}
\end{center}
...
$\square~\dfrac{\text{AB}}{\text{AC}}$ & $\blue\boxtimes~\dfrac{\text{BC}}{\text{AC}}$ & $\square~\dfrac{\text{AC}}{\text{BC}}$ & $\square~\dfrac{\text{AC}}{\text{AB}}$
&&
\psset{unit=1cm}
\begin{pspicture}(-5,-0.5)(-1,3)
%\psgrid
