...
\begin{tabularx}{\linewidth}{|*{4}{>{\centering \arraybackslash}X|}m{1.75cm}|}\hline
...
\rput(-1,-1.75){\psframe[fillstyle=hlines](0.5,0.5)}
\rput(0.2,-1.5){[15~;~20]}
\rput(-1,-1){\psframe[fillstyle=vlines](0.5,0.5)}
\rput(0.2,-0.75){[10~;~15]}
\rput(-1,-0.25){\psframe[fillstyle=solid,fillcolor=gray!20](0.5,0.5)}
\rput(0.2,0){[5~;~10]}
\rput(-1,0.5){\psframe[fillstyle=solid,fillcolor=gray](0.5,0.5)}
\rput(0.2,0.75){[0~;~5]}
\end{pspicture}
\\ \hline
\end{tabularx}
