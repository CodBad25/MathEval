...
\begin{center}
  ...
  \begin{tabular}{|m{.45\textwidth}|>{\centering\arraybackslash}m{.14\textwidth}|>{\centering\arraybackslash}m{.14\textwidth}|>{\centering\arraybackslash}m{.14\textwidth}|}
  \hline
...
% Utiliser \addplot ici, c’est la bonne méthode !
\addplot[domain=-2:4, line width=2pt] {2*x};
\end{axis}
\end{tikzpicture}
\end{center}   
