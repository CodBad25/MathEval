...
Voici une capture d'écran d'un tableau obtenu à l'aide d'un tableur. Il permet de calculer le coût des achats d'Aurel.
...
\item Dans le tableau précédent, compléter chaque cellule de la colonne D par les prix obtenus.
