...
On rappelle que l'instruction \raisebox{-3.5mm}{\begin{scratch}\blockmove{s'orienter à \selectmenu{90} degrés}\end{scratch}} signifie que l'on se dirige vers la droite.
...
\blockvariable{Mettre \selectmenu{côté} à \ovalnum{100}}
