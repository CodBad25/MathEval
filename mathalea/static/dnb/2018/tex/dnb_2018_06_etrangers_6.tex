...
\parbox{0.2\linewidth}{\includegraphics[width=3cm]{robot}}
...
On rappelle que l'instruction \begin{scratch}\blockmove{s'orienter à \selectmenu{0} degrés}\end{scratch} signifie que le robot se dirige vers le haut.
...
\blockmove{s'orienter à \selectmenu{0} degrés}
...
\rput(4.1,0.5){\includegraphics[width=0.5cm]{robot}}
\end{pspicture}\\
