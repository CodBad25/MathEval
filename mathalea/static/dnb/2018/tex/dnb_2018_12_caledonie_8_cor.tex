...
%\smallskip
%
%Le chat \includegraphics[width=0.8cm]{chat} indique la position de départ.
...
\rput{-180}(2,5){\includegraphics[width=0.4cm]{chat}}
\end{pspicture}}
...
%\begin{scratch}
%\blockinit{Quand \greenflag est cliqué}
%\blockvariable{mettre \ovalvariable{pas} à \ovaloperator{\ovalvariable{80}}}
%\blockpen{stylo en position d'écriture}
%\blockmove{s'orienter à \ovaloperator{90}}
...
%	{
%	\blockmove{tourner \turnleft{} de \ovalnum{90} degrés}
%	\blockvariable{mettre \ovalvariable{pas} à \ovaloperator{\ovalvariable{pas} - \ovalnum{20}}}
%	\blockmove{avancer de \ovaloperator{pas}}
%	}
...
%\rput(2,1){\includegraphics[width=0.4cm]{chat}}
%\end{pspicture}
%\end{center}
%
