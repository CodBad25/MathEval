...
`}}}return B+="\\end{tikzpicture}",B}}static multiplication(t,o,s,l){return new A({topBraces:[{start:1,end:8+s*2,text:o!=null?`$${f(o,s)}\\text{ fois}$`:"? fois"}],lignes:[{barres:[{color:"lightgray",length:2+s,content:t!=null?`$${f(t,s)}$`:"?",type:"boite"},{color:"lightgray",length:3,content:"\\ldots",type:"boite"},{color:"lightgray",length:2+s,content:t!=null?`$${f(t,s)}$`:"?",type:"boite"}]},{barres:[{color:"white",length:7+s*2,content:l??"?"}]}]})}static division(t,o,s,l){return new A({topBraces:[{start:1,end:8+2*l,text:s==null?"? fois":`${f(s,0)} fois`}],lignes:[{barres:[{color:"lightgray",length:2+l,content:o==null?"?":`$${f(o,l)}$`,type:"boite"},{color:"lightgray",length:3,content:"\\ldots",type:"boite"},{color:"lightgray",length:2+l,content:o==null?"?":`$${f(o,l)}$`,type:"boite"}]},{barres:[{color:"white",length:7+2*l,content:t==null?"?":`$${f(t,l)}$`}]}]})}static multiplicationPuisDivisionAvecReste(t,o,s,l,b,L){const k=typeof t=="number"?t*3:10;return new A({topBraces:t!=null?typeof t=="string"?[{start:1,end:k+1,text:`${t}`,type:"accolade"}]:[{start:1,end:k+1,text:`${f(t,0)}`,type:"accolade"}]:[{start:1,end:k+1,text:"? fois",type:"accolade"}],lignes:[{spacing:.5,barres:typeof t=="number"?Q(t-1).map(P=>({color:"white",length:3,content:o!=null?typeof o=="number"?`$${f(o,L)}$`:`${o}`:"?",type:"boite"})):[{color:"lightgray",length:3,content:o!=null?typeof o=="number"?`$${f(o,L)}$`:`${o}`:"?",type:"boite"},{color:"lightgray",length:k-3,content:"\\ldots",type:"boite",options:{justify:"start"}}]},{barres:[{color:"lightgray",length:3,content:s!=null?typeof s=="number"?`$${f(s,L)}$`:`${s}`:"?",type:"boite"},{color:"lightgray",length:k-6,content:"\\ldots",type:"boite",options:{justify:"start"}},{color:"lightgray",length:3,content:b!=null?typeof b=="number"?`$${f(b,L)}$`:`${b}`:"?",type:"boite",options:{justify:"center"}}]}],bottomBraces:[{start:1,end:k-2,text:l!=null?typeof l=="string"?l:`$${f(Number(l),L)}$`:"?",type:"flèche"}]})}static divisionAvecReste(t,o,s,l,b){return new A({topBraces:[{start:1,end:8+2*l,text:s==null?"? fois":`$${s}$ fois`}],lignes:[{barres:[{color:"lightgray",length:2+l,content:o==null?"?":`$${f(o,l)}$`},{color:"lightgray",length:3,content:"\\ldots"},{color:"lightgray",length:2+l,content:o==null?"?":`$${f(o,l)}$`},{color:"lightgray",length:2,content:b??"?"}]},{barres:[{color:"white",length:9+2*l,content:t==null?"?":`$${f(t,l)}$`}]}]})}static addition(t,o,s){return new A({lignes:[{barres:[{color:"lightgray",length:2+s,content:t!=null?`$${f(t,s)}$`:"?"},{color:"lightgray",length:2+s,content:o!=null?`$${f(o,s)}$`:"?"}]},{barres:[{color:"white",length:4+s*2,content:"?"}]}]})}static additionPartiesTout(t,o,s){const l=s.length,b=l<3?4:3;return new A({topBraces:[{start:1,end:l*b+1,text:t!=null?typeof t=="string"?t:`$${f(t,o)}$`:"?",type:"accolade"}],lignes:[{barres:s.map((k,O)=>Object.assign({color:"lightgray",length:b,content:k!=null?typeof k=="string"?k:`$${f(Number(k),o)}$`:"?"},{}))}]})}static additionPartiesToutComparaison(t,o,s,l,b){return new A({rightBraces:[{start:1,end:5,text:l!=null?`${f(l,b)}$`:"?",type:"accolade"}],lignes:[{barres:[{color:"lightgray",length:8+b,content:t==null?"?":`$${f(t,b)}$`}]},{barres:[{color:"lightgray",length:4+b,content:o==null?"?":`$${f(o,b)}$`},{color:"white",type:"flèche",length:4+b,content:s!=null?`$${f(s,b)}$`:"différence",options:{style:"border-left: none;border-top: none; border-bottom: none;border-right: dashed;"}}]}]})}static additionPartiesToutComparaison2(t,o,s,l,b,L){return new A(L?Object.assign({},{lignes:[{spacing:.5,barres:[{color:"lightgray",length:3,content:t},{color:"lightgray",length:7,content:o}]},{barres:[{color:"lightgray",length:6,content:s},{color:"white",type:"flèche",length:4,content:l,options:{style:"border-left: none;border-top: none; border-bottom: none;border-right: dashed;"}}]}],topBraces:[{start:1,end:11,text:b,type:"accolade"}]}):Object.assign({},{lignes:[{spacing:.5,barres:[{color:"lightgray",length:3,content:t},{color:"lightgray",length:7,content:o}]},{barres:[{color:"lightgray",length:6,content:s},{color:"white",type:"flèche",length:4,content:l,options:{style:"border-left: none;border-top: none; border-bottom: none;border-right: dashed;"}}]}]}))}static soustraction(t,o,s,l){return new A({lignes:[{barres:[{color:"lightgray",length:2+l,content:t==null?"?":`$${f(t,l)}$`},{color:"lightgray",length:2+l,content:s==null?"?":`$${f(s,l)}$`}]},{barres:[{color:"white",length:4+l*2,content:o==null?"?":`$${f(o,l)}$`}]}]})}}export{A as S};
//# sourceMappingURL=SchemaEnBoite-DaxgHAUP.js.map
