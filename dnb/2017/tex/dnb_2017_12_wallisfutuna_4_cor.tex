...
Compléter le script ci-dessous pour pouvoir réaliser ce motif.
...
L'instruction \raisebox{-2.3ex}{\begin{scratch}\blockmove{s'orienter à  \selectmenu{90} degrés}\end{scratch}} signifie que l'on se dirige vers la droite. \\[2mm]
Les deux instructions à  placer dans la boucle pour finir le script sont les \linebreak instruction \ding{'302}, puis \ding{'300}.}\hfill
