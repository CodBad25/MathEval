...
\end{minipage}
\hspace{1cm}\begin{minipage}[t]{0.28\linewidth}
%\begin{center}
\psset{unit=0.75cm}
\begin{pspicture}(-3.5,-3.5)(3.5,3.5)
\pscircle(0,0){3}
\newgray{gris5}{0.55}\pswedge[fillstyle=solid,fillcolor=gris5](0,0){3}{-41}{90}
\newgray{gris6}{0.65}\pswedge[fillstyle=hlines](0,0){3}{90}{120.24}
\newgray{gris7}{0.75}\pswedge[fillstyle=solid,fillcolor=gris7](0,0){3}{120.24}{138.24}
\newgray{gris8}{0.85}\pswedge[fillstyle=vlines](0,0){3}{138.24}{179.64}
\newgray{gris9}{0.95}\pswedge[fillstyle=solid,fillcolor=gris9](0,0){3}{179.64}{-41}

\end{pspicture}
\end{minipage}
\hspace{1cm}\begin{minipage}[t]{0.1\linewidth}
\psset{unit=1cm}
\begin{pspicture}(-1,5)(1,4)

\newgray{gris9}{0.95}\rput(-1,0.25){\psframe[fillstyle=solid,fillcolor=gris9](0.5,0.5)}
\rput[tl]{0}(-0.2,0.5){Pétrole}
\rput(-1,1.25){\psframe[fillstyle=vlines](0.5,0.5)}
\rput[tl]{0}(-0.2,1.5){Gaz}
\newgray{gris7}{0.75}\rput(-1,2.25){\psframe[fillstyle=solid,fillcolor=gris7](0.5,0.5)}
\rput[tl]{0}(-0.2,2.66){Énergies}
\rput[tl]{0}(-0.2,2.34){renouvelables}
\rput(-1,3.25){\psframe[fillstyle=hlines](0.5,0.5)}
\rput[tl]{0}(-0.2,3.5){Charbon}
\newgray{gris5}{0.55}\rput(-1,4.25){\psframe[fillstyle=solid,fillcolor=gris5](0.5,0.5)}
\rput[tl]{0}(-0.2,4.5){Électricité}
