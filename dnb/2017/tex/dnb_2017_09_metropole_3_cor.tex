...
%	\blockmove{sâ€™orienter à  \ovalnum{90\selectarrownum} degrés}
...
%\end{minipage}
%
%On rappelle que l'instruction \begin{scratch} \blockmove{sâ€™orienter à  \ovalnum{90\selectarrownum} degrés}  \end{scratch} signifie que l'on s'oriente vers la droite avec le stylo.
%
%\medskip
