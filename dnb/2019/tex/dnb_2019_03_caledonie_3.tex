...
\begin{enumerate}
\item On considère la fonction $g$ représentée dans le repère ci-dessous.
...
\bigskip
	...
	\begin{enumerate}
		...
		\item Compléter le tableau de valeurs ci-dessus de la fonction $g$.
 	\end{enumerate}
\item  La fonction $f$ est donnée par $f(x) = 2x$.
	\begin{enumerate}
		\item Quelle est l'image de $- 2$ par la fonction $f$ ?
		\item Calculer $f(3)$.
		\item Dans le graphique ci-dessus, tracer la représentation graphique de la fonction $f$.
 	\end{enumerate}
\item  Déterminer graphiquement l'abscisse du point d'intersection S des deux représentations graphiques.
	
Faire apparaître en pointillés la lecture sur le graphique ci-dessus.
