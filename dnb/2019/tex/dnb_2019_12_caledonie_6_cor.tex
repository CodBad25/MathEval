...
On a $\np{30000} = \np{1500}x$, soit $x = \dfrac{\np{30000}}{\np{1500}} = 20~\left(\text{m}^2\right)$.
		\item %Tracer la représentation graphique de la fonction $A$
...
Ceci signifie que pour 20~m$^2$, les peintres A et B ont le même prix (lisible sur le graphique).
	\end{enumerate}
\item %Lire graphiquement, les surfaces entre lesquelles le peintre B est le moins cher des trois peintres.
