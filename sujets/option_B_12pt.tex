...
%  OPTION B — Police 12pt, un exercice par page
%  Compilé avec : pdflatex option_B_12pt.tex
% ════════════════════════════════════════════════════════════════
...
\begin{center}
  ...
  \textbf{sauf pour l'exercice 1 (automatismes) où elle est interdite.}\\[0.3cm]
...
\begin{tabular}{|p{5cm}|p{3cm}|}
  ...
  Exercice 2 & 2 points  \\ \hline
  Exercice 3 & 3 points  \\ \hline
  Exercice 4 & 3 points  \\ \hline
  Exercice 5 & 2 points  \\ \hline
  Exercice 6 & 4 points  \\ \hline
...
% ──────────────────────────────────────────────────────────────
%  ANNEXE 1 = EXERCICE 1 — Automatismes (questions + réponses)
% ──────────────────────────────────────────────────────────────
\newpage
{\small
...
\centerline{\large\bfseries ANNEXE 1 — Exercice 1 (Automatismes — 6 points)}
\smallskip
\centerline{\textit{À rendre à l'issue des automatismes (20 premières minutes)}}
\smallskip
\centerline{\textit{Aucune justification n'est attendue.}}
\medskip
\centerline{\Large\bfseries CALCULATRICE INTERDITE}
\end{tcolorbox}
\end{center}

\vspace{2pt}

\noindent Numéro de candidat :
\begin{tikzpicture}[baseline=-0.3ex]
  \foreach \i in {1,...,4}{
    \draw (\i*0.55-0.55,0) rectangle ++(0.45,0.45);
  }
\end{tikzpicture}
...
ABCD est un carré et CDE est un triangle équilatéral (E est à l'intérieur du carré ABCD).
...
\vspace{-2pt}
\begin{center}
\fbox{\parbox{0.9\textwidth}{Réponse :\vspace{3cm}\mbox{}}}
\end{center}

\vspace{2pt}

\noindent\textbf{Question 2 :}
Calculer le périmètre d'un cercle de rayon 3~cm.

\vspace{1pt}
\noindent Réponse : \dotfill

\vspace{6pt}

\noindent\textbf{Question 3 :}
Calculer : $77{,}6 \div 10$
...
Le diagramme suivant représente les ventes d'un magasin sur une semaine.
...
Écrire un script Scratch qui dessine un polygone régulier à 5 côtés de 147 pixels de côté.

\vspace{-2pt}
\begin{center}
\fbox{\parbox{0.9\textwidth}{\vspace{2.8cm}\mbox{}}}
\end{center}
...
% ──────────────────────────────────────────────────────────────
%  EXERCICE 5 — Lunettes de soleil (ancien ex 6)
% ──────────────────────────────────────────────────────────────
\exercice{5}{2}
...
% ──────────────────────────────────────────────────────────────
%  EXERCICE 6 — Fonctions (ancien ex 5)
% ──────────────────────────────────────────────────────────────
\exercice{6}{4}
...
\begin{center}
\begin{tikzpicture}[
  block/.style={draw, thick, rectangle, minimum width=1.1cm, minimum height=0.5cm},
...
La représentation graphique $\mathcal{C}_f$ de la fonction $f$ est donnée en \textbf{annexe 2 (à rendre avec la copie)}.
  \begin{enumerate}[label=\alph*., itemsep=3pt]
    ...
    On pourra éventuellement laisser les traits de construction sur \textbf{l'annexe 2}.
  \end{enumerate}
\end{enumerate}
...
On a utilisé un tableur pour réaliser un tableau de valeurs de cette fonction.
  \begin{enumerate}[label=\alph*., itemsep=3pt]
    ...
    \item Tracer la représentation graphique de la fonction $g$ dans le repère sur \textbf{l'annexe 2}.
    \item Déterminer graphiquement les nombres qui ont la même image par les fonctions $f$ et $g$. On pourra laisser apparents les traits de construction sur \textbf{l'annexe 2}.
  \end{enumerate}
\end{enumerate}
\end{minipage}\hfill
...
\centerline{\Large\bfseries ANNEXE 2 — Exercice 6 (Fonctions)}

\smallskip

\centerline{\textit{À rendre avec la copie}}
\end{tcolorbox}
\end{center}
