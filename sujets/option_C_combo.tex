...
%  OPTION C — Police 12pt + regroupements naturels
%  Compilé avec : pdflatex option_C_combo.tex
% ════════════════════════════════════════════════════════════════
...
%% Exercice enchaîné (sans saut de page)
\newcommand{\exercicesuite}[2]{%
  \vspace{0.8cm}%
...
\begin{enumerate}[label=\textbf{\arabic*)}, leftmargin=1.2cm, itemsep=0.7cm]
...
% ──────────────────────────────────────────────────────────────
%  EXERCICE 4 — Jardin botanique (enchaîné après ex 3)
% ──────────────────────────────────────────────────────────────
\exercicesuite{4}{7}
...
% ──────────────────────────────────────────────────────────────
%  EXERCICE 6 — Lunettes de soleil (enchaîné après ex 5)
% ──────────────────────────────────────────────────────────────
\exercicesuite{6}{5}
