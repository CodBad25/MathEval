...
%  OPTION A — Exercices regroupés, police 11pt
%  Compilé avec : pdflatex option_A_regroupe.tex
% ════════════════════════════════════════════════════════════════
...
%% ─── Commande exercice (sans saut de page, séparateur) ───────
...
%% Premier exercice : saut de page après la couverture
\newcommand{\premierexercice}[2]{%
  \newpage
  \noindent{\Large\bfseries Exercice #1\hspace{0.3em}{\normalfont\normalsize(#2 points)}}%
  \par\vspace{0.5cm}%
}
