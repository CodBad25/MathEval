...
`.trim(),h=[];return c===r&&(h.push(m(-k*.6-.2,-y*.6-.2,k*.6+.2,y*.6+.2)),h.push(m(-k*.6-.2,y*.6+.2,k*.6+.2,-y*.6-.2))),h.push(m(-k*.6-.2,0,k*.6+.2,0)),h.push(m(0,-y*.6-.2,0,y*.6+.2)),new n({codeSvg:f,codeTikz:i,width:c/2,height:r/2,axes:h,centre:S(0,0)})}function z(e){const c=(e==null?void 0:e.fillStyle)||"lime",r=(e==null?void 0:e.strokeStyle)||"black",a=(e==null?void 0:e.lineWidth)||1,t=(e==null?void 0:e.rayonExterieur)||1,l=(e==null?void 0:e.rayonInterieur)||.5,$=(e==null?void 0:e.opacite)||1,d=`
    ...
    `.trim(),f=[0,72,144,216,288].map(i=>i+90).map(i=>m(-Math.cos(i*Math.PI/180)*t,-Math.sin(i*Math.PI/180)*t,Math.cos(i*Math.PI/180)*t,Math.sin(i*Math.PI/180)*t));return new n({codeSvg:d,codeTikz:y,width:t*2,height:t*2,axes:f,opacite:$})}function W(e){const c=(e==null?void 0:e.fillStyle)||"blue",r=(e==null?void 0:e.strokeStyle)||"black",a=(e==null?void 0:e.lineWidth)||1,t=(e==null?void 0:e.rayon)||3,l=(e==null?void 0:e.opacite)||1,w=`
        ...
        `.trim(),k=[`(0,${l/2})`,`(${t},${l*.35})`,`(0,${-l/2})`,`(${-t},${l*.35})`].join(" -- "),y=`
            % Cerf-volant
            \\draw[fill=${c}, draw=${r}, line width=${a}pt] ${k} -- cycle;
        `.trim(),f=[m(0,-l*.6,0,l*.6)];return new n({codeSvg:d,codeTikz:y,width:t,height:l,axes:f,opacite:$})}function j(e){const c=(e==null?void 0:e.fillStyle)||"yellow",r=(e==null?void 0:e.strokeStyle)||"black",a=(e==null?void 0:e.lineWidth)||1,t=(e==null?void 0:e.base)||3,l=(e==null?void 0:e.hauteur)||4,$=(e==null?void 0:e.opacite)||1,d=`
  ...
  `.trim(),f=Math.asin(w/d)*180/Math.PI,i=`
    ...
    \\draw[fill=${c}, draw=${r}, line width=${a}pt] 
      ...
      -- cycle;
  `.trim(),h=[m(-.5,0,w,0)];return new n({codeSvg:y,codeTikz:i,width:t>l?d:w,height:t>l?d:w,axes:h,angle:$,opacite:k})}function A(e){const c=(e==null?void 0:e.fillStyle)||"yellow",r=(e==null?void 0:e.strokeStyle)||"black",a=(e==null?void 0:e.lineWidth)||1,t=(e==null?void 0:e.opacite)||1,$=`<path d="${`
        M 0,0
        L 40,0
        A 40,40 0 1,1 0,-40
        Z
  ...
  `.trim();return new n({codeSvg:y,codeTikz:i,width:t+Math.abs(d/10),height:l,centre:S(0,0),nonAxe:m((-t/2+d/40)*2.5,l*1.25,(t/2-d/40)*2.5,-l*1.25),opacite:w})}function R(e){const c=(e==null?void 0:e.fillStyle)||"pink",r=(e==null?void 0:e.strokeStyle)||"black",a=(e==null?void 0:e.lineWidth)||1,t=(e==null?void 0:e.base)||2,l=(e==null?void 0:e.opacite)||1,$=`
    <path d="
      M 0,${-t*10}
...
% Etoile à 4 branches
  ...
  `.trim(),u=[m(-t*5/8,0,t*5/8,0),m(0,-l*5/8,0,l*5/8)];return new n({codeSvg:f,codeTikz:h,width:t,height:l,axes:u,centre:S(0,0),angle:$,opacite:w})}function V(e){const c=(e==null?void 0:e.fillStyle)||"blue",r=(e==null?void 0:e.strokeStyle)||"black",a=(e==null?void 0:e.lineWidth)||1,t=(e==null?void 0:e.base)||4,l=(e==null?void 0:e.hauteur)||2,$=(e==null?void 0:e.opacite)||1,d=`
    <polygon points="${[`0,${-l*10}`,`${t*10},${l*10}`,`${-t*10},${l*10}`].join(" ")}" fill="${c}" stroke="${r}" stroke-width="${a}" />
  `.trim(),k=[`(0,${-l/2})`,`(${t/2},${l/2})`,`(${-t/2},${l/2})`].join(" -- "),y=`
  % triangle isocèle
    \\draw[fill=${c}, draw=${r}, line width=${a}pt] ${k} -- cycle;
  `.trim(),f=[m(0,-l*5/8,0,l*5/8)];return new n({codeSvg:d,codeTikz:y,width:t,height:l,axes:f,opacite:$})}function H(e){const c=(e==null?void 0:e.fillStyle)||"blue",r=(e==null?void 0:e.strokeStyle)||"black",a=(e==null?void 0:e.lineWidth)||1,t=(e==null?void 0:e.base)||4,l=(e==null?void 0:e.opacite)||1,$=Math.round(Math.sqrt(3)/2*t*100)/100,d=`
  ...
  `.trim();return new n({codeSvg:l,codeTikz:k,width:4,height:2,opacite:t,axes:[m(-2.2,0,2.2,0),m(0,-1.2,0,1.2)],centre:S(0,0)})}function X(e){const c=(e==null?void 0:e.fillStyle)||"yellow",r=(e==null?void 0:e.strokeStyle)||"black",a=(e==null?void 0:e.lineWidth)||1,t=(e==null?void 0:e.borderFillSyle)||"white",l=`
  ...
  `.trim(),i=[m(-1,-1,1,1),m(-1,1,1,-1)];return new n({codeSvg:$,codeTikz:f,width:2,height:2,axes:i,centre:S(0,0)})}function G(e){const c=(e==null?void 0:e.fillStyle)||"blue",r=(e==null?void 0:e.strokeStyle)||"red",a=(e==null?void 0:e.lineWidth)||5,l=`
  ...
  `.trim(),f=[m(-1,-1,1,1),m(-1,1,1,-1)];return new n({codeSvg:l,codeTikz:y,width:2,height:2,axes:f,centre:S(0,0)})}function J(e){const c=(e==null?void 0:e.fillStyle)||"red",r=(e==null?void 0:e.strokeStyle)||"white",a=(e==null?void 0:e.lineWidth)||2,t=(e==null?void 0:e.textColor)||"white",l=`
  ...
  `.trim(),$=`
    ...
    `.trim();return new n({codeSvg:l,codeTikz:$,width:2,height:2,nonAxe:m(0,-2.5,0,2.5)})}function K(e){const c=(e==null?void 0:e.fillStyle)||"blue",r=(e==null?void 0:e.strokeStyle)||"black",a=(e==null?void 0:e.lineWidth)||1,t=(e==null?void 0:e.tFillStyle)||"white",l=(e==null?void 0:e.barFillStyle)||"red",$=`
  ...
  `.trim(),d=[m(0,-1.2,0,1.2)];return new n({codeSvg:$,codeTikz:w,width:2,height:2,axes:d})}function Q(e){const c=(e==null?void 0:e.fillStyle)||"blue",r=(e==null?void 0:e.strokeStyle)||"black",a=(e==null?void 0:e.lineWidth)||1,t=(e==null?void 0:e.pFillStyle)||"white",l=`
    <rect x="-20" y="-20" width="40" height="40" rx="5" fill="white" stroke="${r}" stroke-width="${a}" />
    <rect x="-17" y="-17" width="34" height="34" fill="${c}" />
  ...
  `.trim();return new n({codeSvg:d,codeTikz:f,width:2,height:2,nonAxe:m(0,-2.5,0,2.5)})}function p(e){const c=(e==null?void 0:e.fillStyle)||"white",r=(e==null?void 0:e.strokeStyle)||"red",a=(e==null?void 0:e.lineWidth)||3,t=(e==null?void 0:e.borderStyle)||"black",l=(e==null?void 0:e.borderWidth)||1,$=[90,-30,-150].map(i=>`${(22*Math.cos(i*Math.PI/180)).toFixed(2)},${(-22*Math.sin(i*Math.PI/180)).toFixed(2)}`).join(" "),w=[90,-30,-150].map(i=>`${(19*Math.cos(i*Math.PI/180)).toFixed(2)},${(-19*Math.sin(i*Math.PI/180)).toFixed(2)}`).join(" "),d=`
    <polygon points="${$}" fill="${c}" stroke="${t}" stroke-width="${l}" />
    <polygon points="${w}" fill="none" stroke="${r}" stroke-width="${a}" />
  ...
  `.trim();return new n({codeSvg:d,codeTikz:f,width:2,height:2,nonAxe:m(0,-2.5,0,2.5)})}function ee(e){const c=(e==null?void 0:e.fillStyle)||"white",r=(e==null?void 0:e.strokeStyle)||"red",a=(e==null?void 0:e.lineWidth)||3,t=(e==null?void 0:e.borderStyle)||"black",l=(e==null?void 0:e.borderWidth)||1,$=[90,-30,-150].map(h=>`${(22*Math.cos(h*Math.PI/180)).toFixed(2)},${(-22*Math.sin(h*Math.PI/180)).toFixed(2)}`).join(" "),w=[90,-30,-150].map(h=>`${(19*Math.cos(h*Math.PI/180)).toFixed(2)},${(-19*Math.sin(h*Math.PI/180)).toFixed(2)}`).join(" "),d=`
    <polygon points="${$}" fill="${c}" stroke="${t}" stroke-width="${l}" />
    <polygon points="${w}" fill="none" stroke="${r}" stroke-width="${a}" />
  ...
  % panneauRetrecissementChaussee2
    ...
    \\draw[draw=black, line width=2pt] (0.195,-0.3) -- (0.195,-0.1) -- (0.1,0.1) -- (0.1,0.3);
  `.trim(),i=[m(0,-1.2,0,1.2)];return new n({codeSvg:d,codeTikz:f,width:2,height:2,axes:i})}function te(e){const c=(e==null?void 0:e.fillStyle)||"white",r=(e==null?void 0:e.strokeStyle)||"red",a=(e==null?void 0:e.lineWidth)||3,t=(e==null?void 0:e.borderStyle)||"black",l=(e==null?void 0:e.borderWidth)||1,$=[90,-30,-150].map(i=>`${(22*Math.cos(i*Math.PI/180)).toFixed(2)},${(-22*Math.sin(i*Math.PI/180)).toFixed(2)}`).join(" "),w=[90,-30,-150].map(i=>`${(19*Math.cos(i*Math.PI/180)).toFixed(2)},${(-19*Math.sin(i*Math.PI/180)).toFixed(2)}`).join(" "),d=`
    <polygon points="${$}" fill="${c}" stroke="${t}" stroke-width="${l}" />
    <polygon points="${w}" fill="none" stroke="${r}" stroke-width="${a}" />
   <line x1="2" y1="6" x2="2" y2="-6" stroke="black" stroke-width="2" />
    <path d="M -3.5,6 L -3.5,2 L -2,-2 L -2,-6" stroke="black" stroke-width="2" fill="none" />
  ...
  `.trim(),i=[m(0,-1.2,0,1.2)];return new n({codeSvg:d,codeTikz:f,width:2,height:2,axes:i})}function ce(e){const c=(e==null?void 0:e.fillStyle)||"white",r=(e==null?void 0:e.strokeStyle)||"red",a=(e==null?void 0:e.lineWidth)||3,t=(e==null?void 0:e.borderStyle)||"black",l=(e==null?void 0:e.borderWidth)||1,$=[90,-30,-150].map(h=>`${(22*Math.cos(h*Math.PI/180)).toFixed(2)},${(-22*Math.sin(h*Math.PI/180)).toFixed(2)}`).join(" "),w=[90,-30,-150].map(h=>`${(19*Math.cos(h*Math.PI/180)).toFixed(2)},${(-19*Math.sin(h*Math.PI/180)).toFixed(2)}`).join(" "),d=`
    <polygon points="${$}" fill="${c}" stroke="${t}" stroke-width="${l}" />
    <polygon points="${w}" fill="none" stroke="${r}" stroke-width="${a}" />
  ...
  `.trim(),i=[m(0,-1.2,0,1.2)];return new n({codeSvg:d,codeTikz:f,width:2,height:2,axes:i})}function ae(e){const c=(e==null?void 0:e.fillStyle)||"red",r=(e==null?void 0:e.strokeStyle)||"red",a=(e==null?void 0:e.lineWidth)||2,l=`${`
  ...
  `.trim(),y=[m(-1.2,0,1.2,0),m(0,-1.2,0,1.2)];return new n({codeSvg:l,codeTikz:k,width:2,height:2,axes:y,centre:S(0,0)})}function $e(e){const c=(e==null?void 0:e.fillStyle)||"red",r=(e==null?void 0:e.strokeStyle)||"red",a=(e==null?void 0:e.lineWidth)||2,t=`
     <circle cx="0" cy="0" r="20" fill="${c}" stroke="black" stroke-width="1" />
        <circle cx="0" cy="0" r="18" fill="${c}" stroke="${r}" stroke-width="0" />
  ...
  `.trim(),f=[m(-1,-1,1,1),m(-1,1,1,-1)];return new n({codeSvg:l,codeTikz:y,width:2,height:2,axes:f,centre:S(0,0)})}function he(e){const c=(e==null?void 0:e.fillStyle)||"blue",r=(e==null?void 0:e.strokeStyle)||"red",a=(e==null?void 0:e.lineWidth)||5,t="red",l=`
    <circle cx="0" cy="0" r="20" stroke="black" stroke-width="1" />
    <circle cx="0" cy="0" r="17" fill="${c}" stroke="${r}" stroke-width="${a}" />
  ...
  `.trim(),$=`fill=${c}`,w=`draw=${r}`,d=`line width=${a*1.1}pt`,k="red",y=`
    ...
    \\draw[${k}, line width=5pt] (-0.7,0.7) -- (0.7,-0.7);
  `.trim(),f=[m(-1.2,0,1.2,0),m(0,-1.2,0,1.2),m(-1,-1,1,1),m(-1,1,1,-1)];return new n({codeSvg:l,codeTikz:y,width:2,height:2,axes:f,centre:S(0,0)})}export{T as A,D as B,E as C,R as D,Z as E,_ as F,B as G,O as H,q as I,V as J,H as K,ce as L,te as M,ae as a,he as b,X as c,Y as d,G as e,J as f,le as g,p as h,ee as i,re as j,K as k,F as l,$e as m,Q as n,N as o,A as p,L as q,j as r,s,v as t,W as u,z as v,C as w,U as x,o as y,de as z};
//# sourceMappingURL=panneaux-NTSPefVj.js.map
