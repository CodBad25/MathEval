...
%
% ... est une capture d'écran d'un tableau obtenu à l'aide d'un tableur. Il permet de calculer le coût des achats d'Aurel.
%
%\medskip
...
$=\text{B}2 * \text{C}2$.
\item %compléter chaque cellule de la colonne D par les prix obtenus.
\medskip
