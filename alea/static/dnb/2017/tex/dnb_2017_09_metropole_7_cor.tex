...
La population dépasse \np{10000} après 7 quarts d'heure ou 1 h 3/4.
 	\end{enumerate}
\item %On souhaite tester l'efficacité d'un antibiotique pour lutter contre la bactérie légionelle. On introduit l'antibiotique dans un récipient qui contient $10^4$ bactéries légionelles au temps $t = 0$. La représentation graphique donne le nombre de bactéries dans le récipient en fonction du temps.
