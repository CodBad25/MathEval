...
\item  %Un élève trace les deux figures A et B que vous trouverez en \textbf

%Placer \textbf{qui est à rendre avec la copie}, le centre O  de la symétrie centrale qui transforme la figure A en figure B.
\end{enumerate}
\begin{center}
