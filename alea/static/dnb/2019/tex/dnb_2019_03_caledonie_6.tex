...
\item Dessiner, ci-dessous,  le parallélogramme obtenu avec la \textbf{longueur} et l'\textbf{angle} donnés.


\begin{center}

\parbox{0.35\linewidth}{longueur : 80
...
\blocksensing{demander \ovalnum{Donne une longueur} et attendre}
\blockvariable{mettre \selectmenu{longueur} à \ovalsensing{réponse}}
\blocksensing{demander \ovalnum{Donne un angle} et attendre}
