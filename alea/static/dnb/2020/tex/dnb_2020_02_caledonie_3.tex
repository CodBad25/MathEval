...
On donne ci-dessous la représentation graphique de la masse moyenne théorique des
...
\begin{enumerate}
\item Répondre aux questions suivantes en utilisant le graphique ci-dessus
	\begin{enumerate}
		\item La masse moyenne théorique des crevettes est-elle proportionnelle au nombre de jours passés
dans le bassin? Justifier la réponse.
...
\end{center}
	...
	\begin{enumerate}
		\item Placer les points A(120~;~23), B(145~;~231) et C(175~;~238) sur le graphique ci-dessus.
