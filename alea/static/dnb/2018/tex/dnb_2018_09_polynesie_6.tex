...
\blockinfloop{répéter jusqu'à \booloperator{\ovaloperator{\ovaloperator{\ovalvariable{x} * \ovalnum{2}} * \ovalnum{15}} > \ovalnum{999}}}
{\blockvariable{ajouter à \selectmenu{x} \ovalnum{1}}
}
\blocklook{dire \ovaloperator{regroupe{\ovalnum{La solution est :}} et \ovalvariable{x}}}
