...
\textit{Dans ce cas, le niveau de l'eau dans l'écluse est le même qu'en amont.}
\item Le graphique ci-dessous représente la vitesse d'écoulement de l'eau par la Vantelle en fonction du niveau $x$ de l'eau dans l'écluse
...
\textit{Par lecture graphique, la vitesse d'écoulement est de \fbox{$4$ m/s} lorsque la hauteur de l'eau dans l'écluse est de $3,4$~m} (voir les pointillés sur le graphique).
\end{enumerate}
