...
\begin{enumerate}
\item La fonction $f$ correspond à  la formule saisie dans la cellule B2 car  $f(0)=2\times 0=0$ alors que $g(0)=-2\times 0+8=8$. 
\item Dans la cellule B5, on saisit \quad $=-2*$B4$+8$ 
\item La fonction $f$ est représentée dans le repère qui suit car, par exemple $f(0) = 0$ alors que $g(0) = 8$. 
\item 
...
Graphiquement, la solution de l'équation est l'abscisse du point  d'intersection des deux droites. \\
