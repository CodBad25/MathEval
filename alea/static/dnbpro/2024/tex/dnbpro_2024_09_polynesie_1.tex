...
\psplot[plotpoints=500,linecolor=blue]{-1}{4}{4 3 x mul sub}
\end{pspicture*}
&
...
\multido{\n=-2+2}{4}{\psline[linewidth=0.15pt,linecolor=gray](\n,-6)(\n,8)}
\multido{\n=-6+2}{7}{\psline[linewidth=0.15pt,linecolor=gray](-2,\n)(4,\n)}
\psplot[plotpoints=500,linecolor=blue]{-1}{4}{3 x mul 4 sub}
\end{pspicture*}
&
...
L'image de 1 par $f$ est :&12&4&7\\ 
\hline
\textbf{3.} Il y a 13 cartes trèfles dans un jeu de 52 cartes.

La probabilité de tirer un trèfle est :&$\dfrac14$&$\dfrac{1}{52}$&$\dfrac{1}{13}$\\ 
\hline
\textbf{4.} Une réduction de $20\,\%$ est\newline accordée sur un article de sport de \np{3000}~F.

Le montant de cette réduction est de : &600 F&60 F&\np{3020} F\\ 
\hline
\textbf{5.} On considère l'équation 

$2x + 6 = 0$.

La solution de cette équation est :&$-3$& 0 &3\\ 
\hline
\textbf{6.}  Il y a $71$~km entre Papeete et 

Teahupo'o. Le bus met deux heures pour effectuer ce trajet.

La vitesse moyenne du bus en km/h est de:&142 km/h&71 km/h&35,5 km/h\\ \hline
\end{tabular}
\end{center}
