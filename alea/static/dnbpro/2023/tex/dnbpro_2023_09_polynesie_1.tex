...
\textbf{N$\degres$} & \centering\textbf{Questions} & \textbf{Réponse A} & \textbf{Réponse B} & \textbf{Réponse C}\\
 \hline
1. & Soient les 6 nombres suivants:\newline 18\;;\;2\;;\;14\;;\;5\;;\;8\;;\;16\newline La moyenne est: & $9,5$ & $10,5$ & $15,5$\\
\hline
2. & La forme développée de\newline $(x+2)(x+3)$ est: & $x^2+5$ & $x^2+5x+6$ & $x^2+6$\\
\hline
3. & Soit le triangle ABC tel que\newline AB = 3 cm, BC = 4 cm et AC = 5 cm.\newline Ce triangle est-il rectangle? & OUI & NON & On ne peut pas savoir.\\
\hline
4. & $\qquad\qquad\dfrac{2}{5}- \dfrac{1}{5}=$\rule[-15pt]{0pt}{35pt} & 1 & 0 & $\dfrac{1}{5}$\\
\hline
&&&&\\
...
& $\dfrac{8}{3}\pi$ & $\dfrac{24}{3}\pi$ & $\dfrac{32}{3}\pi$\\
\hline
\end{tabularx} }
