...
$\bullet~~$D'après le théorème de Thalès : $\dfrac{\text{FH}}{\text{BC}} = \dfrac{\text{AF}}{\text{AC}}$, soit $\dfrac{\text{FH}}{5,2} = \dfrac{4}{6,5}$, d'où en multipliant chaque membre par $5,2$ : $\text{FH} = \dfrac{4 \times 5,2}{6,5} = \dfrac{4 \times 52}{65} = \dfrac{4 \times 4 \times 13}{5 \times 13} = \dfrac{16}{5} = \dfrac{32}{10} = 3,2$~(m).
