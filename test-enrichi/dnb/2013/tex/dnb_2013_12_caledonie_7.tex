...
Cette année 25 établissements se sont inscrits. Plus de \np{3000}~élèves, répartis comme l'indique le tableau ci-dessous, ont participé à ce concours.
...
\begin{enumerate}
\item Compléter le tableau ci-dessus. Les cases barrées ne sont pas à remplir. 
...
\item Le tableau ci-dessus est une copie d'écran d'un tableur. 
