...
On a $\widehat{\text{XBC}} = 180 - 120 = 60(\degres{})$.
		\item %Sur l'ann-exe, compléter les deux informations manquantes du bloc Hexagone pour qu'il trace un hexagone régulier.
...
\item %On considère le script ci-contre qui utilise le bloc Hexagone de l'ann-exe : 
	\begin{enumerate}
