...
\end{scratch}}
%Compléter les deux informations manquantes du script qui permet de réaliser la figure ci-dessous
...
%\end{pspicture}
%\end{center}
\item  %En ordonnant les instructions, compléter le script permettant de réaliser la figure ci-dessous. On indiquera les numéros des instructions.
