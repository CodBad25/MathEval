...
\textbf{Indication }: on pourra utiliser les instructions \begin{scratch}\blockvariable{mettre la couleur du stylo \`a \ovalvariable{\black rouge}}\end{scratch} 

et \begin{scratch}\blockvariable{mettre la couleur du stylo \`a \ovalvariable{\black noir}}\end{scratch} pour choisir la couleur du stylo.
