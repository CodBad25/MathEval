...
\begin{scratch}\blocksensing{demander \ovalnum{Saisir un nombre} et attendre}\end{scratch}&\raisebox{12pt}{2}\\
\begin{scratch}\blockvariable{mettre \ovalvariable{x} à {\ovaloperator{\ovalmove{réponse} + \ovalnum{5}}}}\end{scratch}&\raisebox{12pt}{3}\\
\begin{scratch}\blockvariable{mettre \ovalvariable{x} à {\ovaloperator{\ovalvariable{x} * \ovalnum{2}}}}\end{scratch}&\raisebox{12pt}{4}\\
\begin{scratch} \blockvariable{mettre \ovalvariable{x} à \ovaloperator{\ovalvariable{x} - \ovalmove{réponse}}} \end{scratch}&\raisebox{12pt}{5}\\
\begin{scratch}\blocklook{dire \ovaloperator{regroupe \ovalnum{Le programme de calcul donne} et {\ovalvariable{x}}}}
\end{scratch}&\raisebox{12pt}{6}\\ 
\hline
\end{tabularx}
\end{center}
...
\begin{scratch}\blockvariable{mettre \ovalvariable{x} \`à {\ovaloperator{\ovalnum{7} * \ovalmove{réponse}}}}\end{scratch}\\
\begin{scratch}\blockvariable{mettre \ovalvariable{x} \`à {\ovalvariable{x} - \ovalnum{8}}}\end{scratch}\\
\begin{scratch}\blocklook{dire \ovaloperator{regroupe \ovalnum{Le programme de calcul donne} et {\ovalvariable{x}}}}
\end{scratch}\\ 
\hline
\end{tabularx}
...
\hfill\begin{scratch}
\blockvariable{mettre \ovalvariable{x} à {\ovaloperator{\ovalmove{réponse} + \ovalnum{10}}}}
\end{scratch}
\end{minipage}
