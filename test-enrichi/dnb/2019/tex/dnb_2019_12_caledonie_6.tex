...
On a $A(x) = \np{1500}x$ et $C(x)= \np{70000}$.
	\begin{enumerate}
		...
		\item Tracer la représentation graphique de la fonction $A$ dans le repère précédent.
	\end{enumerate}
\item 
	\begin{enumerate}
	...
	\end{enumerate}
\item Lire graphiquement, sur le graphique précédent, les surfaces entre lesquelles le peintre B est le moins cher des trois peintres.
\end{enumerate}
