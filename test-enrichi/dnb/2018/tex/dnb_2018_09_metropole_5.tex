...
On rappelle que l'instruction \begin{scratch} \blockmove{s'orienter à \ovalnum{90} degrés} \end{scratch} signifie que l'on s'oriente vers la droite.
}\hfill
...
\blockvariable{mettre \selectmenu{Longueur} à \ovalnum{50}}
\blockvariable{mettre \selectmenu{Largeur} à \ovalnum{30}}
...
afin d'obtenir la figure ci-dessous. On recopiera et on complétera sur sa copie les lignes 9 et 10 ainsi que l'instruction manquante en ligne 11.
