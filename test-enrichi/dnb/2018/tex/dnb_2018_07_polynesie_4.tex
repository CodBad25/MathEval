...
\end{center}
	...
	\begin{enumerate}
		\item Compléter sur le tableau ci-dessous, la colonne intitulée \og Angle en degrés correspondant \fg.
		\item 
		\begin{center}
...
correspondants.})
		...
		\item Compléter sur le tableau ci-dessus la colonne \og Fréquence en \% \fg. (\emph{Pour expliquer votre démarche, vous ferez figurer sur votre copie les calculs correspondants. Vous donnerez le résultat arrondi au centième près.})
	\end{enumerate}
\end{enumerate}
