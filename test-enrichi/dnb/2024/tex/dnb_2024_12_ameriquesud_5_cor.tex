...
%\textbf{Bloc \og Losange \fg }&\textbf{Losange obtenu}\\
...
$\bullet~$~Les quatre côtés d'un losange ont la même longueur, il faut donc avancer de $a = 20$ ;

$\bullet~$~On a tourné de $60\degres$, donc pour revenir en arrière il faut tourner de $180 - 60 = 120(\degres)$
...
On écrit un script du bloc \og Motif B \fg.
